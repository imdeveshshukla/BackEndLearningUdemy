...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs", {a:"Welcome to", b:"Band Generator"});
});

app.post("/submit", (req, res) => {
  //Step 2 - Make the generate name functionality work
  let lenA = adj.length;
  let lenB = noun.length;
  let x = Math.floor(Math.random() * lenA);
  let y = Math.floor(Math.random() * lenB);

  const a = adj[x];
  const b = noun[y];


  res.render("index.ejs",{a:a , b:b});
